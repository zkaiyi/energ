        ...
        $.ajax({
            ...
            success:function (res2) {
                ...
                for(var i= 0 ;i<data.length;i++){
                    var html = '<div class="col-container-item clearfix" data-typeid="'+data[i].ID+'">\n' +
                        '            <a >\n' +
                        '                <div class="col-container-item-fl fl"><img class="col-container-item-fl-img col-container-item-fl-img-adds01 hide" src="img/col/col-item-icon.png" /><img class="col-container-item-fl-img col-container-item-fl-img-adds hide" src="img/col/col-item-iconss.png" /></div>\n' +
                        '                <div class="col-container-item-fr fl">\n' +
